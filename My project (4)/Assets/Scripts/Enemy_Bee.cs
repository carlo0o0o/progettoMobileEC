...
public class Enemy_Bee : Enemy
{
    ...
    void Update()
    {
        ...
        if (!aggresive)
        {
            transform.position = Vector2.MoveTowards(transform.position, idlePoint[idlePointIndex].position, defaultSpeed * Time.deltaTime);
        ...
        else
        {
            ...
            transform.position = Vector2.MoveTowards(transform.position, newPosition, defaultSpeed * Time.deltaTime);
